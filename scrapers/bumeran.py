            ...
            for page in range(self.max_pages):
                ...
                for card in cards:
                    try:
                        ...
                        if not href:
                            link_els_all = card.find_elements(By.TAG_NAME, "a")
                            for a in link_els_all:
